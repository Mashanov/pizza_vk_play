...
users = {
    ...
    0: [
        ...
        ['Мне только пепперони', ['pepperoni']],
        ['Здравствуйте, мне бы вашу пиццу с фирменным соусом и нежной колабаской', ['соус', 'pepperoni']],
        ['Могу я попробовать пиццу с соусом и пепперони колбасой ?', ['соус', 'pepperoni']],
        ['У меня аллергия на соус, мне только колбасу', ['pepperoni']],
        ['Я не люблю пиццу, но вашу попробую, мне с колбаской', ['pepperoni']],
        ['Я давно не ел пиццу с соусом и пепперони', ['соус', 'pepperoni']],
        ['Соус и пепперони, без лишних слов', ['соус', 'pepperoni']],
    ...
    1: [
        ...
        ['Сделай мне пиццу с пепперони и грибами', ['mushrooms', 'pepperoni']],
        ['Грибы, пепперони и соус, и побыстрее !', ['соус', 'mushrooms', 'pepperoni']],
    ...
    2: [
        ...
        ['Пиццу с пепперони, грибами и зеленью', ['mushrooms', 'pepperoni', 'greenery']],
        ['Обожаю грибы и зелень', ['mushrooms', 'greenery']],
        ['А сделай как мне пиццу с колбаской и зеленью', ['pepperoni', 'greenery']],
        ['Обожаю пепперони, зелень и грибы', ['pepperoni', 'greenery', 'mushrooms']],
        ['Здравствуйте, хотелось бы великолепной пепперони, зелени добавь и соуса немного', ['pepperoni', 'greenery', 'соус']],
    ],

    3: [

        ['Помидорок бы мне и зелень', ['tomatoes', 'greenery']],
        ['Эй, здарова, мне томаты, зелень и пепперони', ['tomatoes', 'greenery', 'pepperoni']],
    ...
    4: [
        ...
        ['Вот тебе большой заказ: соус, огурцы, помидоры, грибы, пепперони, запомнил ?', ['соус', 'cucumber', 'tomatoes', 'mushrooms', 'pepperoni']],
        ...
        for (var element of voiceUser[1])
        {
            ...
            forElement++;
                ...
                if (i == 0)
                {
                    ...
                    if (element == 'pepperoni') result ('Мало пепперони', -1);
